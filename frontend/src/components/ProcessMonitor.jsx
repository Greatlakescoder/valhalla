            ...
            <ResponsiveContainer width="100%" height="100%">
                <LineChart
                    data={[
                        {
                            name: 'Resources',
                            cpu: parseFloat(attributes.CpuUsage), // This will correctly convert "150.5" to 150.5
                            memory: parseFloat(attributes.MemoryUsage),
                            totalMemory: parseFloat(attributes.TotalMemory || 0),
                            totalCpu: parseFloat(attributes.TotalCpu || 0),
                        }
                    ]}
                >
